...
$('.add-to-cart').on('click', function(e){
    ...
    if($(this).hasClass('added')){
       $(this).removeClass('added').find('i').removeClass('icofont-ui-check').addClass('icofont-airplane-alt').siblings('span').text('sepete ekle');
    } else{
        $(this).addClass('added').find('i').addClass('icofont-ui-check').removeClass('icofont-airplane-alt').siblings('span').text('Sepette'); 
    }
});
/*--
	Wishlist & Compare
